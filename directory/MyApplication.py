...
class Application(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.master.title("D Drive")
        
        self.greet_button = Button(master, text="Run Drive Program", command=self.main)
        self.greet_button.pack()
        
        self.quit_button = Button(master, text="Quit", command=self.quit)
        self.quit_button.pack()
        
    def printSomething(self, master=None):
                # if you want the button to disappear:
                # button.destroy() or button.pack_forget()
        
        label = Label(master, text= "Test: THE LABEL WORKS")
    ...
    def main(self):
        ...
        print_label = self.printSomething()
        print_label #Did this to make function easier to call
